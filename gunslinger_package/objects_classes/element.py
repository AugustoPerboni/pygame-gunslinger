...
class Element:
    ...
    def life_bar(self,window):
        ...
        if self.life < (self.max_life/5)*1:
            self.life_color = (255,13,13)
        elif self.life < (self.max_life/5)*2:
            self.life_color = (255,78,17)
        elif self.life < (self.max_life/5)*3:
            self.life_color = (250,183,51)
        elif self.life < (self.max_life/5)*4:
        ...
        pygame.draw.rect(window,self.life_color,(self.life_bar_x,self.life_bar_y,(self.life/self.max_life)*100,10))
